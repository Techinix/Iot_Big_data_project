...
CO2consumer = KafkaConsumer('CO2_Topic',auto_offset_reset= "latest",bootstrap_servers= 'localhost:9092')



data={}
for message in CO2consumer :
    message_data = message.value.decode('utf-8')  # Decode message if needed
    # Insert message into MongoDB
    data["CO2"]=message_data
    CO2_col.insert_one(data)
