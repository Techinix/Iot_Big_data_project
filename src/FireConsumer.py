...
Fireconsumer = KafkaConsumer('FireDetection_Topic',auto_offset_reset= "latest",bootstrap_servers= 'localhost:9092')



data={}
for message in Fireconsumer :
    message_data = message.value.decode('utf-8')  # Decode message if needed
    # Insert message into MongoDB
    data["Fire"]=message_data
    Fire_col.insert_one(data)
