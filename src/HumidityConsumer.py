...
Humidity_col = db['Humidity']
print("connection to mongo succeeded!")
Humidityconsumer = KafkaConsumer('Humidity_Topic',auto_offset_reset= "latest",bootstrap_servers= 'localhost:9092')



data={}
for message in Humidityconsumer :
    message_data = message.value.decode('utf-8')  # Decode message if needed
    # Insert message into MongoDB
    data["Humidity"]=message_data
    Humidity_col.insert_one(data)
