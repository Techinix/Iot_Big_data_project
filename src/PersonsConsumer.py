...
Personsconsumer = KafkaConsumer('PersonsCount_Topic',auto_offset_reset= "latest",bootstrap_servers= 'localhost:9092')



data={}
for message in Personsconsumer :
    message_data = message.value.decode('utf-8')  # Decode message if needed
    # Insert message into MongoDB
    data["Persons"]=message_data
    Persons_col.insert_one(data)
